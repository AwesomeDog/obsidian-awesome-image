...
const toolbar = (title: string, className: string, icon: string, enableMenu = true): ToolbarConfig => ({
  title, class: className, icon, enableToolbarIcon: true, enableMenu, enableHotKey: true,
});

export const TOOLBAR_CONF: ToolbarConfig[] = [
  toolbar("ZOOM_TO_100", "toolbar_zoom_to_100", "zoom-to-100"),
  toolbar("ZOOM_IN", "toolbar_zoom_in", "zoom-in", false),
  toolbar("ZOOM_OUT", "toolbar_zoom_out", "zoom-out", false),
  toolbar("FULL_SCREEN", "toolbar_full_screen", "expand"),
  toolbar("REFRESH", "toolbar_refresh", "refresh-ccw"),
  toolbar("ROTATE_LEFT", "toolbar_rotate_left", "rotate-ccw"),
  toolbar("ROTATE_RIGHT", "toolbar_rotate_right", "rotate-cw"),
  toolbar("SCALE_X", "toolbar_scale_x", "move-horizontal"),
  toolbar("SCALE_Y", "toolbar_scale_y", "move-vertical"),
  toolbar("INVERT_COLOR", "toolbar_invert_color", "droplet"),
  toolbar("COPY", "toolbar_copy", "copy"),
  {title: SEPARATOR_SYMBOL, enableToolbarIcon: false, enableMenu: true, enableHotKey: false},
  {title: "CLOSE", class: "toolbar_close", icon: "trash", enableToolbarIcon: false, enableMenu: true, enableHotKey: true},
];

export const IMG_FULL_SCREEN_MODE = {FIT: "FIT", FILL: "FILL", STRETCH: "STRETCH"} as const;
...
export const IMG_BORDER_WIDTH = {THIN: "thin", MEDIUM: "medium", THICK: "thick"} as const;
export const IMG_BORDER_STYLE = {
  DOTTED: "dotted", DASHED: "dashed", SOLID: "solid", DOUBLE: "double",
  GROOVE: "groove", RIDGE: "ridge", INSET: "inset", OUTSET: "outset",
} as const;
export const IMG_BORDER_COLOR = {
  BLACK: "black", BLUE: "blue", DARK_GREEN: "darkgreen", GREEN: "green", LIME: "lime",
  STEEL_BLUE: "steelblue", INDIGO: "indigo", PURPLE: "purple", GRAY: "gray",
  DARK_RED: "darkred", LIGHT_GREEN: "lightgreen", BROWN: "brown", LIGHT_BLUE: "lightblue",
  SILVER: "silver", RED: "red", PINK: "pink", ORANGE: "orange", GOLD: "gold", YELLOW: "yellow",
} as const;

export const GALLERY_NAVBAR_DEFAULT_COLOR = "#0000001A";
export const GALLERY_NAVBAR_HOVER_COLOR = "#0000004D";
export const GALLERY_IMG_BORDER_ACTIVE_COLOR = "#FF0000";
export const MODIFIER_HOTKEYS = {
  NONE: "NONE", CTRL: "CTRL", ALT: "ALT", SHIFT: "SHIFT", CTRL_ALT: "CTRL_ALT",
  CTRL_SHIFT: "CTRL_SHIFT", SHIFT_ALT: "SHIFT_ALT", CTRL_SHIFT_ALT: "CTRL_SHIFT_ALT",
} as const;
export const MOVE_THE_IMAGE = {
  CODE: "MOVE_THE_IMAGE", DEFAULT_HOTKEY: MODIFIER_HOTKEYS.NONE,
...
export const SWITCH_THE_IMAGE = {
  CODE: "SWITCH_THE_IMAGE", DEFAULT_HOTKEY: MODIFIER_HOTKEYS.CTRL,
...
export enum CONTAINER_TYPE {MAIN, PIN}
export type ContainerType = "MAIN" | "PIN";
